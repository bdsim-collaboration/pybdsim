...
def BdsimElement2TransferMatrix(bdsfile,element,outputType="list"):
    ...
    """
    Calculates the Transfer Matrix of an element in a BDSIM beamline from an output (non-optical) rootfile of the beamline by using a Singular Value Decomposition pseudoinverse of a matrix of particle trajectories.
    ...
    outputtype - "list", "dict" (default "list"). Controls output type, list returns a 16-element list of floats of the matrix elements, dict returns a dict of labelled elements r11 through r44.
    """
    ...
    if outputType == "dict" :
        ...
        output = [xrow.item(0),xrow.item(1),xrow.item(2),xrow.item(3),xprow.item(0),xprow.item(1),xprow.item(2),xprow.item(3),yrow.item(0),yrow.item(1),yrow.item(2),yrow.item(3),yprow.item(0),yprow.item(1),yprow.item(2),yprow.item(3)]
           
    else:
        print 'invalid output type, use "dict" or "list"'
