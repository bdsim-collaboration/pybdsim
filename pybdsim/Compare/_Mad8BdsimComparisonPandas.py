...
def _AddSurvey(figure, survey):
	if survey is None:
		...
		_pymad8.PlotPandas.AddMachineLatticeToFigure(figure,survey)

def Mad8VsBDSIMpandas(twiss, bdsim, survey=None, functions=None,
	...
	twissL = _pymad8.OutputPandas(twiss)
...
def PlotEnergy(mad8opt, bdsopt, survey=None, functions=None, postfunctions=None, figsize=(12,5), xlim=(0,0)) :
	...
	_plt.errorbar(bdsopt['S'], bdsopt['Mean_E'],yerr=bdsopt['Sigma_Mean_E'],
                  label=r'BDSIM $E$' + ' ; N = ' + N,marker='x',ls = '',color='b')
