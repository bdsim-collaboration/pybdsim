...
def Machine2Ocelot(bdsmachine, s0=0):
    ...
    tws0.dx = float(bdsmachine.beam['dx'].split('*')[0])
    tws0.dy = float(bdsmachine.beam['dy'].split('*')[0])
    tws0.dpx = float(bdsmachine.beam['dpx'].split('*')[0])
    tws0.dpy = float(bdsmachine.beam['dpy'].split('*')[0])
